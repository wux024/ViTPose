...
class AnimalStandfordExtraDataset(Kpt2dSviewRgbImgTopDownDataset):
    """AnimalStanfordExtraDataset for animal pose estimation.
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile('configs/_base_/datasets/standfordextra.py')
